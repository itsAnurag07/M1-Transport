...
function Home({ navigateTo, navigateToHomeAndScroll }) {
  return (
    <>
      ...
      {/* Testimonial Section */}
      <section className="py-section-padding px-6 w-full max-w-7xl mx-auto bg-surface-container-lowest editorial-shadow rounded-card opacity-100 translate-y-0">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center p-12">
          <div>
