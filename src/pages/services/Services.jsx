...
function Services({ navigateTo, navigateToHomeAndScroll }) {
  // Estimator State
  const [origin, setOrigin] = useState('Sydney');
  const [destination, setDestination] = useState('Melbourne');
  const [serviceType, setServiceType] = useState('linehaul');
  ...
  const calculateTransitTime = () => {
    ...
    const routes = {
      ...
      'Sydney-Brisbane': '1-2 Business Days',
      'Brisbane-Sydney': '1-2 Business Days',
      'Melbourne-Brisbane': '2-3 Business Days',
      'Brisbane-Melbourne': '2-3 Business Days',
      'Sydney-Adelaide': '2-3 Business Days',
      'Adelaide-Sydney': '2-3 Business Days',
      'Melbourne-Adelaide': '1-2 Business Days',
      'Adelaide-Melbourne': '1-2 Business Days',
      'Sydney-Perth': '4-5 Business Days',
      'Perth-Sydney': '4-5 Business Days',
      'Melbourne-Perth': '4-5 Business Days',
      'Perth-Melbourne': '4-5 Business Days',
    };
    const key = `${origin}-${destination}`;
    return routes[key] || '3-4 Business Days';
  };
  ...
  const hubs = ['Sydney', 'Melbourne', 'Brisbane', 'Adelaide', 'Perth'];
      ...
      <section className="relative h-[60vh] min-h-[400px] overflow-hidden opacity-100 translate-y-0 bg-black flex items-center" id="services-hero">
        ...
        <div className="relative max-w-7xl mx-auto w-full px-4 sm:px-6 text-white pt-6 md:pt-20 hero-text-container">
          ...
          <p className="text-base sm:text-lg md:text-xl font-light text-white/85 max-w-2xl leading-relaxed">
            High-velocity freight, reliable linehaul corridors, and smart logistics solutions.
          </p>
        </div>
      </section>
              ...
              >
                ...
                <g id="states-group" stroke="rgba(255, 255, 255, 0.15)" strokeWidth="0.4" fill="transparent">
                  ...
                  <path
                    ...
                    aria-label="Queensland Fraser Island"
                    className="transition-all duration-300 hover:stroke-white/45 hover:fill-white/5 cursor-pointer"
                  ...
                  <path
                    ...
                    aria-label="South Australia Kangaroo Island"
                    className="transition-all duration-300 hover:stroke-white/45 hover:fill-white/5 cursor-pointer"
                  ...
                  <path
                    id="sa-mainland"
                    aria-label="South Australia Mainland"
                    className="transition-all duration-300 hover:stroke-white/45 hover:fill-white/5 cursor-pointer"
                  ...
                  <path
                    id="tas-cape-barren"
                    aria-label="Tasmania Cape Barren"
                    className="transition-all duration-300 hover:stroke-white/45 hover:fill-white/5 cursor-pointer"
                  ...
                  <path
                    ...
                    aria-label="Tasmania Flinders Island"
                    className="transition-all duration-300 hover:stroke-white/45 hover:fill-white/5 cursor-pointer"
                  ...
                  <path
                    ...
                    aria-label="Tasmania King Currie Island"
                    className="transition-all duration-300 hover:stroke-white/45 hover:fill-white/5 cursor-pointer"
                ...
                <g>
                  ...
                  <g fill="#E11919">
                    ...
                    <circle cx="-0.8" cy="0.8" r="0.25" />
                    <circle cx="1.1" cy="0.8" r="0.25" />
                    <animateMotion dur="8s" repeatCount="indefinite" rotate="auto" path="M 176,187 Q 103,122 30,175" />
                  </g>
                  ...
                  <g fill="#E11919">
                    ...
                    <circle cx="-0.8" cy="0.8" r="0.25" />
                    <circle cx="1.1" cy="0.8" r="0.25" />
                    <animateMotion dur="4.5s" repeatCount="indefinite" rotate="auto" path="M 176,187 Q 190,165 220,209" />
                  </g>
                  {/* Melbourne -> Adelaide */}
                  <g fill="#E11919">
                    <path d="M -2.5,-0.8 L 0.5,-0.8 L 0.5,-0.4 L 1.5,-0.4 L 1.8,0 L 1.8,0.6 L -2.5,0.6 Z" />
                    ...
                    <circle cx="-0.8" cy="0.8" r="0.25" />
                    <circle cx="1.1" cy="0.8" r="0.25" />
                    <animateMotion dur="4.5s" repeatCount="indefinite" rotate="auto" path="M 220,209 Q 190,165 176,187" />
                  </g>
                  ...
                  <g fill="#E11919">
                    ...
                    <circle cx="-0.8" cy="0.8" r="0.25" />
                    <circle cx="1.1" cy="0.8" r="0.25" />
                    <animateMotion dur="4s" repeatCount="indefinite" rotate="auto" path="M 220,209 Q 235,183 261,172" />
                  </g>
                  {/* Sydney -> Melbourne */}
                  <g fill="#E11919">
                    <path d="M -2.5,-0.8 L 0.5,-0.8 L 0.5,-0.4 L 1.5,-0.4 L 1.8,0 L 1.8,0.6 L -2.5,0.6 Z" />
                    ...
                    <circle cx="-0.8" cy="0.8" r="0.25" />
                    <circle cx="1.1" cy="0.8" r="0.25" />
                    <animateMotion dur="4s" repeatCount="indefinite" rotate="auto" path="M 261,172 Q 235,183 220,209" />
                  </g>
                  ...
                  <g fill="#E11919">
                    ...
                    <circle cx="-0.8" cy="0.8" r="0.25" />
                    <circle cx="1.1" cy="0.8" r="0.25" />
                    <animateMotion dur="3.5s" repeatCount="indefinite" rotate="auto" path="M 261,172 Q 262,144 271,120" />
                  </g>
                  {/* Brisbane -> Sydney */}
                  <g fill="#E11919">
                    <path d="M -2.5,-0.8 L 0.5,-0.8 L 0.5,-0.4 L 1.5,-0.4 L 1.8,0 L 1.8,0.6 L -2.5,0.6 Z" />
                    ...
                    <circle cx="-0.8" cy="0.8" r="0.25" />
                    <circle cx="1.1" cy="0.8" r="0.25" />
                    <animateMotion dur="3.5s" repeatCount="indefinite" rotate="auto" path="M 271,120 Q 262,144 261,172" />
                  </g>

                  {/* Melbourne -> Tasmania (Spirit of Tasmania Ferry connection - using a shipping dot) */}
                  <circle r="1.5" fill="#E11919">
                    <animateMotion dur="3s" repeatCount="indefinite" path="M 220,209 L 235,245" />
                  </circle>
                </g>

                {/* Capital City Hub Nodes (Pulsing Glow + City Names) */}

                {/* Perth */}
                <circle cx="30" cy="175" r="6" fill="rgba(225, 25, 25, 0.15)" />
                <circle cx="30" cy="175" r="4.5" fill="none" stroke="#E11919" strokeWidth="0.8" opacity="0.8" className="animate-ping" style={{ transformOrigin: '30px 175px', animationDuration: '3s' }} />
                <circle cx="30" cy="175" r="2" fill="#E11919" />
                <text x="36" y="174" className="fill-white font-black" style={{ fontSize: '4.2px', fontFamily: 'Hanken Grotesk, sans-serif', letterSpacing: '0.08em' }}>PERTH</text>
                <text x="36" y="178.5" className="fill-white/40 font-bold" style={{ fontSize: '2.8px', fontFamily: 'Hanken Grotesk, sans-serif', letterSpacing: '0.08em' }}>DEPOT</text>

                {/* Adelaide */}
                <circle cx="176" cy="187" r="6" fill="rgba(225, 25, 25, 0.15)" />
                <circle cx="176" cy="187" r="4.5" fill="none" stroke="#E11919" strokeWidth="0.8" opacity="0.8" className="animate-ping" style={{ transformOrigin: '176px 187px', animationDuration: '3s' }} />
                <circle cx="176" cy="187" r="2" fill="#E11919" />
                <text x="170" y="185.5" textAnchor="end" className="fill-white font-black" style={{ fontSize: '4.2px', fontFamily: 'Hanken Grotesk, sans-serif', letterSpacing: '0.08em' }}>ADELAIDE</text>
                <text x="170" y="190" textAnchor="end" className="fill-white/40 font-bold" style={{ fontSize: '2.8px', fontFamily: 'Hanken Grotesk, sans-serif', letterSpacing: '0.08em' }}>DEPOT</text>

                {/* Melbourne (HQ Hub) */}
                <circle cx="220" cy="209" r="9.5" fill="rgba(225, 25, 25, 0.22)" />
                <circle cx="220" cy="209" r="6.5" fill="none" stroke="#E11919" strokeWidth="1" opacity="0.95" className="animate-ping" style={{ transformOrigin: '220px 209px', animationDuration: '2s' }} />
                <circle cx="220" cy="209" r="3.5" fill="#E11919" />
                <text x="220" y="222" textAnchor="middle" className="fill-[#E11919] font-black" style={{ fontSize: '4.8px', fontFamily: 'Hanken Grotesk, sans-serif', letterSpacing: '0.08em' }}>MELBOURNE (HQ)</text>
                <text x="220" y="226.5" textAnchor="middle" className="fill-white/50 font-bold" style={{ fontSize: '3.2px', fontFamily: 'Hanken Grotesk, sans-serif', letterSpacing: '0.08em' }}>PRIMARY HUB</text>

                {/* Sydney */}
                <circle cx="261" cy="172" r="7.5" fill="rgba(225, 25, 25, 0.18)" />
                <circle cx="261" cy="172" r="5" fill="none" stroke="#E11919" strokeWidth="0.8" opacity="0.85" className="animate-ping" style={{ transformOrigin: '261px 172px', animationDuration: '2.5s' }} />
                <circle cx="261" cy="172" r="2.5" fill="#E11919" />
                <text x="254" y="171" textAnchor="end" className="fill-white font-black" style={{ fontSize: '4.2px', fontFamily: 'Hanken Grotesk, sans-serif', letterSpacing: '0.08em' }}>SYDNEY</text>
                <text x="254" y="175.5" textAnchor="end" className="fill-white/40 font-bold" style={{ fontSize: '2.8px', fontFamily: 'Hanken Grotesk, sans-serif', letterSpacing: '0.08em' }}>DEPOT</text>

                {/* Brisbane */}
                <circle cx="271" cy="120" r="6" fill="rgba(225, 25, 25, 0.15)" />
                <circle cx="271" cy="120" r="4.5" fill="none" stroke="#E11919" strokeWidth="0.8" opacity="0.8" className="animate-ping" style={{ transformOrigin: '271px 120px', animationDuration: '3s' }} />
                <circle cx="271" cy="120" r="2" fill="#E11919" />
                <text x="265" y="118.5" textAnchor="end" className="fill-white font-black" style={{ fontSize: '4.2px', fontFamily: 'Hanken Grotesk, sans-serif', letterSpacing: '0.08em' }}>BRISBANE</text>
                <text x="265" y="123" textAnchor="end" className="fill-white/40 font-bold" style={{ fontSize: '2.8px', fontFamily: 'Hanken Grotesk, sans-serif', letterSpacing: '0.08em' }}>DEPOT</text>

                {/* Hobart */}
                <circle cx="235" cy="245" r="4.5" fill="rgba(225, 25, 25, 0.1)" />
                <circle cx="235" cy="245" r="3.5" fill="none" stroke="#E11919" strokeWidth="0.6" opacity="0.65" className="animate-ping" style={{ transformOrigin: '235px 245px', animationDuration: '4s' }} />
                <circle cx="235" cy="245" r="1.5" fill="#E11919" />
                <text x="241" y="244" className="fill-white font-bold opacity-80" style={{ fontSize: '4px', fontFamily: 'Hanken Grotesk, sans-serif', letterSpacing: '0.08em' }}>HOBART</text>
                <text x="241" y="248" className="fill-white/30 font-bold" style={{ fontSize: '2.8px', fontFamily: 'Hanken Grotesk, sans-serif', letterSpacing: '0.08em' }}>FEEDER</text>
              </svg>
            </div>
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => {
              ...
              return (
                <div
                  key={`faq-${index}`}
                  className="bg-white border border-outline-variant/30 rounded-xl overflow-hidden transition-all duration-300 shadow-sm"
                >
                  <button
                    onClick={() => toggleFaq(index)}
                    className="w-full flex items-center justify-between p-6 text-left font-sans font-bold text-lg text-primary focus:outline-none cursor-pointer bg-transparent border-none outline-none"
                  >
                    <span>{faq.question}</span>
                    <span className={`material-symbols-outlined text-secondary font-black transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`}>
                      keyboard_arrow_down
                    </span>
                  </button>
                  <div
