              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <button
                      className={`py-4 px-4 rounded-lg font-bold text-sm tracking-wide uppercase border text-center transition-all cursor-pointer ${
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <g stroke="#E11919" strokeWidth="2.2" opacity="0.12" fill="none" strokeLinecap="round">
                <path d="M 30,175 L 176,187" />
                <path d="M 176,187 L 220,209" />
                <path d="M 220,209 L 261,172" />
                <path d="M 261,172 L 271,120" />
                <path d="M 176,187 L 261,172" />
              ...
              <g stroke="#E11919" strokeWidth="0.6" opacity="0.65" fill="none" strokeLinecap="round" strokeDasharray="1.5,2.5">
                <path id="route-perth-adelaide" d="M 30,175 L 176,187" />
                <path id="route-adelaide-melbourne" d="M 176,187 L 220,209" />
                <path id="route-melbourne-sydney" d="M 220,209 L 261,172" />
                <path id="route-sydney-brisbane" d="M 261,172 L 271,120" />
                <path id="route-adelaide-sydney" d="M 176,187 L 261,172" />
                <path id="route-melbourne-tasmania" d="M 220,209 L 235,245" />
              </g>

              {/* Animated Freight Pulses (Dots moving along key corridors) */}
              <g fill="#E11919">
                {/* Perth -> Adelaide */}
                <circle r="1.5">
                  <animateMotion dur="8s" repeatCount="indefinite" path="M 30,175 L 176,187" />
                </circle>
                {/* Adelaide -> Perth */}
                <circle r="1.5">
                  <animateMotion dur="8s" repeatCount="indefinite" path="M 176,187 L 30,175" />
                </circle>
                
                {/* Adelaide -> Melbourne */}
                <circle r="1.5">
                  <animateMotion dur="4.5s" repeatCount="indefinite" path="M 176,187 L 220,209" />
                </circle>
                {/* Melbourne -> Adelaide */}
                <circle r="1.5">
                  <animateMotion dur="4.5s" repeatCount="indefinite" path="M 220,209 L 176,187" />
                </circle>

                {/* Melbourne -> Sydney */}
                <circle r="1.5">
                  <animateMotion dur="4s" repeatCount="indefinite" path="M 220,209 L 261,172" />
                </circle>
                {/* Sydney -> Melbourne */}
                <circle r="1.5">
                  <animateMotion dur="4s" repeatCount="indefinite" path="M 261,172 L 220,209" />
                </circle>

                {/* Sydney -> Brisbane */}
                <circle r="1.5">
                  <animateMotion dur="3.5s" repeatCount="indefinite" path="M 261,172 L 271,120" />
                </circle>
                {/* Brisbane -> Sydney */}
                <circle r="1.5">
                  <animateMotion dur="3.5s" repeatCount="indefinite" path="M 271,120 L 261,172" />
                </circle>
              ...
              <text x="267" y="171" className="fill-white font-black" style={{ fontSize: '4.2px', fontFamily: 'Hanken Grotesk, sans-serif', letterSpacing: '0.08em' }}>SYDNEY</text>
              <text x="267" y="175.5" className="fill-white/40 font-bold" style={{ fontSize: '2.8px', fontFamily: 'Hanken Grotesk, sans-serif', letterSpacing: '0.08em' }}>DEPOT</text>
                ...
                >
                  ...
                  <div
                    className={`transition-all duration-300 ease-in-out ${
                      isOpen ? 'max-h-60 border-t border-outline-variant/10 p-6' : 'max-h-0 overflow-hidden'
                    }`}
                  >
